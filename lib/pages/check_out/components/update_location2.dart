...
class UpdateLocation2 extends StatefulWidget {
  static String routeName = '/updateaddress2';
  const UpdateLocation2({Key? key}) : super(key: key);
  @override
  State<UpdateLocation2> createState() => _UpdateLocation2State();
}

class _UpdateLocation2State extends State<UpdateLocation2> {
  String? latitude;
  String? longitude;
  String? address;
